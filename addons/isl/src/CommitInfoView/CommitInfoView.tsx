      ...
      const answer = await showOptionModal({
        ...
        message: (
          <div className="commit-info-confirm-modal-paragraphs">
            <div>
              <T replace={{$gtSubmit: <code>gt submit</code>, $ghstack: <code>gh stack</code>}}>
                You can use $gtSubmit (Graphite) or $ghstack to submit for code review on GitHub.
              </T>
            </div>
            <div>
              <T
            ...
            <Link href="https://graphite.dev/docs">
              <T>Learn More</T>
            </Link>
          </div>
        ),
